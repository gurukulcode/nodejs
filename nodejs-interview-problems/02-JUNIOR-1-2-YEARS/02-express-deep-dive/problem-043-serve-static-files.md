# Problem #043: Serve Static Files

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#express #static #files`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Serve Static Files**.
...
console.log('Problem #043: Serve Static Files');
```
