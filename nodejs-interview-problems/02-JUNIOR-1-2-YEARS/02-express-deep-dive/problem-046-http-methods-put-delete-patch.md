# Problem #046: HTTP Methods - PUT, DELETE, PATCH

**Difficulty**: 🟡 Medium
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#express #http-methods #rest`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **HTTP Methods - PUT, DELETE, PATCH**.
...
console.log('Problem #046: HTTP Methods - PUT, DELETE, PATCH');
```
