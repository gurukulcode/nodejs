# Problem #034: Promise.allSettled() vs Promise.all()

**Difficulty**: 🟡 Medium
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#promises #comparison #error-handling`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Promise.allSettled() vs Promise.all()**.
...
console.log('Problem #034: Promise.allSettled() vs Promise.all()');
```
