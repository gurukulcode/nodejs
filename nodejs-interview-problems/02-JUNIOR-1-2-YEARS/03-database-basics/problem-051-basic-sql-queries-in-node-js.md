# Problem #051: Basic SQL Queries in Node.js

**Difficulty**: 🟡 Medium
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#sql #queries #postgresql`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Basic SQL Queries in Node.js**.
...
console.log('Problem #051: Basic SQL Queries in Node.js');
```
