# Problem #061: Read Large Files with Streams

**Difficulty**: 🟡 Medium
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#streams #readable #files`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Read Large Files with Streams**.
...
console.log('Problem #061: Read Large Files with Streams');
```
