# Problem #015: Synchronous vs Asynchronous Code Flow

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#sync #async #execution`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Synchronous vs Asynchronous Code Flow**.
...
console.log('Problem #015: Synchronous vs Asynchronous Code Flow');
```
