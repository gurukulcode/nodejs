# Problem #013: Async/Await - Basics and Usage

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#async-await #promises #syntax`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Async/Await - Basics and Usage**.
...
console.log('Problem #013: Async/Await - Basics and Usage');
```
