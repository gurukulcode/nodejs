# Problem #011: Promises - Create and Use

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#promises #async #error-handling`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Promises - Create and Use**.
...
console.log('Problem #011: Promises - Create and Use');
```
