# Problem #009: Callback Functions - Basics

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#callbacks #async #fundamentals`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Callback Functions - Basics**.
...
console.log('Problem #009: Callback Functions - Basics');
```
