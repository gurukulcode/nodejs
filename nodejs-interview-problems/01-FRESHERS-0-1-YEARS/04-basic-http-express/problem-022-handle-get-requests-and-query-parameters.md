# Problem #022: Handle GET Requests and Query Parameters

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#http #get #query-params`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Handle GET Requests and Query Parameters**.
...
console.log('Problem #022: Handle GET Requests and Query Parameters');
```
