# Problem #024: Express.js - Basic Setup and Routing

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#express #routing #setup`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Express.js - Basic Setup and Routing**.
...
console.log('Problem #024: Express.js - Basic Setup and Routing');
```
