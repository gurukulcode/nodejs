# Problem #025: Create Simple REST API with CRUD Endpoints

**Difficulty**: 🟡 Medium
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#express #rest-api #crud`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Create Simple REST API with CRUD Endpoints**.
...
console.log('Problem #025: Create Simple REST API with CRUD Endpoints');
```
