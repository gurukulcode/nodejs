# Problem #029: Error Handling in Promises - .catch()

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#errors #promises #catch`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Error Handling in Promises - .catch()**.
...
console.log('Problem #029: Error Handling in Promises - .catch()');
```
