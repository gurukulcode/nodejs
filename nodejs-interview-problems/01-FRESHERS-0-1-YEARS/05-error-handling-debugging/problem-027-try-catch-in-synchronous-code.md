# Problem #027: Try-Catch in Synchronous Code

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#errors #try-catch #sync`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Try-Catch in Synchronous Code**.
...
console.log('Problem #027: Try-Catch in Synchronous Code');
```
