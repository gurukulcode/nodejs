# Problem #019: Check File Existence and Get Stats

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#fs #file-stats #exists`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Check File Existence and Get Stats**.
...
console.log('Problem #019: Check File Existence and Get Stats');
```
