# Problem #020: Path Module - Working with File Paths

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#path #file-paths #utilities`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Path Module - Working with File Paths**.
...
console.log('Problem #020: Path Module - Working with File Paths');
```
