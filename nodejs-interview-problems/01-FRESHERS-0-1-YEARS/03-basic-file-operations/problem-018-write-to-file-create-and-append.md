# Problem #018: Write to File - Create and Append

**Difficulty**: 🟢 Easy
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#fs #file-write #append`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **Write to File - Create and Append**.
...
console.log('Problem #018: Write to File - Create and Append');
```
