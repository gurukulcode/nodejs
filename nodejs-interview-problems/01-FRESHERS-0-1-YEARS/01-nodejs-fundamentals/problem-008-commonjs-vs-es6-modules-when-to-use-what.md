# Problem #008: CommonJS vs ES6 Modules - When to Use What

**Difficulty**: 🟡 Medium
**Category**: Node.js Interview Problems
**Experience Level**: Determined by folder level
**Topic Tags**: `#modules #comparison #best-practices`

---

## 📋 Problem Statement

Write a detailed problem statement here. This problem covers **CommonJS vs ES6 Modules - When to Use What**.
...
console.log('Problem #008: CommonJS vs ES6 Modules - When to Use What');
```
